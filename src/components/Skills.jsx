...
const Skills = () => {
    ...
    return (
        <section
            id="skills"
            className={`pt-32 pb-20 min-h-screen ${isDarkMode ? "bg-gradient-to-b from-[#1A8A51] to-[#101828]" : "bg-gradient-to-b from-[#1A8A51] to-[#ffffff]"
                }`}
        >
            <div className="container mx-auto px-4 sm:px-8 md:px-16">
                {/* Título da Seção */}
                <h2 className={`text-5xl md:text-7xl font-bold mb-12 text-center caveat ${isDarkMode ? "text-green-400" : "text-[#1A8A51]"
