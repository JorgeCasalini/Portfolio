...
const About = () => {
    ...
    return (
        <section id="sobre" className="pt-32 pb-20 bg-primary-100 min-h-screen flex items-center">
            <div className="container mx-auto px-4 sm:px-8 md:px-16 flex flex-col md:flex-row items-center justify-center">
                ...
                <div className="w-full md:w-1/2 mb-8 md:mb-0 md:pr-8 text-center md:text-left">
                    <h2 className="text-7xl font-bold text-green-400 mb-6 caveat" data-aos="fade-up-right" data-aos-duration="2500">{t("aboutTitle")}</h2>
                    <p className="mb-10 text-primary-700 text-lg break-words text-start lato-thin " data-aos="fade-up-right" data-aos-duration="3000">
                        {t("aboutTextDev")} <br/>
                ...
                {/* Div com Foto */}
                <div className="w-full md:w-1/2 relative flex justify-center" data-aos="fade-up-left" data-aos-duration="2000" >
